...
TC_GAME_API extern GameTable<GtChallengeModeDamageEntry>            sChallengeModeDamageGameTable;
TC_GAME_API extern GameTable<GtChallengeModeHealthEntry>            sChallengeModeHealthGameTable;
