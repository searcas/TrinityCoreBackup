...
{
    static const DB2LoadInfo* Instance()
    {
        static const DB2FieldMeta fields[] =
        {
            {false, FT_STRING, "Name"},
            {false, FT_STRING, "Description"},
            {false, FT_INT,    "ID"},
        ...
        static const DB2LoadInfo loadInfo(&fields[0], std::extent<decltype(fields)>::value, JournalInstanceMeta::Instance(), HOTFIX_SEL_JOURNAL_INSTANCE);
        return &loadInfo;
    }
};
...
struct MapChallengeModeInfo
{
    static const DB2LoadInfo* Instance()
    {
        ...
        static const DB2LoadInfo loadinfo(&fields[0], std::extent<decltype(fields)>::value, MapChallengeModeMeta::Instance(), HOTFIX_SEL_MAP_CHALLENGE_MODE);
        return &loadinfo;
    }
};
