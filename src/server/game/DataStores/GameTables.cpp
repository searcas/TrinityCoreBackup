...
GameTable<GtChallengeModeDamageEntry>           sChallengeModeDamageGameTable;
GameTable<GtChallengeModeHealthEntry>           sChallengeModeHealthGameTable;
...
#define LOAD_GT(store, file) gameTableCount += LoadGameTable(bad_gt_files, store, gtPath / file); ++expectedGameTableCount;
    ...
    LOAD_GT(sChallengeModeDamageGameTable, "ChallengeModeDamage.txt");
    LOAD_GT(sChallengeModeHealthGameTable, "ChallengeModeHealth.txt");
