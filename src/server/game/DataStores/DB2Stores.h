...
public:
    ...
    const std::vector<const JournalEncounterItemEntry*>* GetJournalItem(uint32 encounterId) const;
    const std::vector<const JournalEncounterEntry*>* GetJournalEncounter(uint32 instanceId)const;
    const JournalInstanceEntry* GetJournalInstanceMap(uint32 mapId);
